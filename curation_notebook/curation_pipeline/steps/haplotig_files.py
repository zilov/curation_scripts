...
from curation_pipeline.output import print_done, print_info, print_next_step, print_step_header, print_warning


def ensure_haplotig_files(ctx: CurationContext) -> None:
    """
