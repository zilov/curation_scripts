...
- [] 21. Для TODO. Изменить парсинг аргументов в cli, для каждого шага должен быть доступен свой help и специфичные для шага параметры. протестировать два подхода click и argparse. как пример ожидаемого вида парсинга и организации команд тулза sourmash (можно посмотреть conda activate sourmash && sourmash --help)
