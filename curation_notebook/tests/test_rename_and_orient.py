...
@patch("curation_pipeline.steps.rename_and_orient.subprocess.run")
@patch("curation_pipeline.steps.rename_and_orient.glob.glob")
def test_run_rename_and_orient_finds_files_and_runs_command(mock_glob, mock_run, mock_ctx, tmp_path):
...
@patch("curation_pipeline.steps.rename_and_orient.glob.glob", return_value=[])
