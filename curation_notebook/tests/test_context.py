...
from curation_pipeline.context import CurationContext, _detect_assembly_type, _derive_workdir
...
def test_build_context_nfs_paths(mock_ctx):
    assert mock_ctx.pretext_maps_nfs == Path(
        "/nfs/treeoflife-01/teams/grit/data/pretext_maps"
    )
